...
void RobotContainer::ConfigureButtonBindings()
{
  ...
  frc2::JoystickButton leftBumperDriver{&m_driverController, frc::XboxController::Button::kX};
  leftBumperDriver.OnTrue(&m_ShortShootPosition).OnTrue(&m_FeedShootVelocity);
